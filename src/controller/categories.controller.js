...
class CategoriesController {
    ...
    async updateCategories(req, res) {
        try {
            const categories = await categoriesService.updateCategories(
                req.body,
            ...
            return sendResponse(res, {
                ...
                message: RESPONSE_MESSAGES.CATEGORIES_UPDATED,
                success: true,
                data: categories,
            });
        } catch (error) {
        ...
        try {
            ...
            if (!categories) {
                return sendResponse(res, {
                    ...
                    message: RESPONSE_MESSAGES.CATEGORIES_NOT_FOUND,
                    sucess: false,
                });
            }
            ...
            return sendResponse(res, {
                status: HTTP_STATUS.OK,
                message: RESPONSE_MESSAGES.CATEGORIES_DELETE,
                sucess: true,
                data: categories,
            });
        } catch (error) {
    ...
    async fetchAllCategoriesList(req, res) {
        try {
            ...
            return sendResponse(res, {
                ...
                message: categories.length
                    ? RESPONSE_MESSAGES.FETCH_ALL_CATEGORIES
                    : RESPONSE_MESSAGES.NO_CATEGORIES,
                data: categories,
            });
        } catch (error) {
            console.error("Error => ", error);
